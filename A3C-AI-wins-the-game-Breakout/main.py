...
class Params():
    def __init__(self):
        ...
        self.env_name = 'Breakout-v0'       #Breakout version or other atari game name
...
env = create_atari_env(params.env_name) # we create an optimized environment thanks to universe (package in open ai gym)
